...
public struct CodeScannerView: UIViewControllerRepresentable {
    ...
    public var completion: (Swift.Result<String, ScanError>) -> Void

    public init(codeTypes: [AVMetadataObject.ObjectType], simulatedData: String = "", completion: @escaping (Swift.Result<String, ScanError>) -> Void) {
